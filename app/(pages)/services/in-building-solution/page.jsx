          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-foreground">
                In Building Solution <span className="text-primary">(IBS)</span>
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-10 items-start mb-12">
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  ...
                  <p>
                    Telecom Carriers and OEMs facing rapid capacity demands from
                    millions of mobile devices increasingly need reliable indoor
                    signal penetration. Implementing specialized IBS / DAS
                    solutions in high-density areas is crucial for competition.
                    Experience shows that the typical Return on Investment for a
                    dedicated in-building system is achieved quickly, coupled
                    with better service and overall customer satisfaction.
                  </p>
                </div>
              ...
              <div className="mt-16">
                <h3 className="text-2xl md:text-3xl font-bold mb-8 text-foreground">
                  Major areas of <span className="text-primary">expertise</span>{' '}
                  include
                </h3>
