...
const menuItems = [
  ...
  },
  {
    ...
    icon: Truck,
    children: [
      { title: 'Vendor List', url: '/admin/vendors/vendor-list', icon: Truck },
      {
                ...
                <SidebarGroupContent>
                  <SidebarMenu className="space-y-2">
                    {menuItems.map((item) => {
                      ...
                      // 2) Parent item with children (Project Management, Inventory, Vendors, Reports & Settings)
                      return (
                        <div key={item.title} className="mb-2">
                          ...
                          {/* Children list – visible only when open */}
                          {sectionOpen && (
                            <div className="ml-2 border-l border-white/30 pl-1 space-y-1">
                                              ...
                                              <ChildIcon
                                                className={cn(
                                                  ...
                                                  hoveredItem === child.title &&
                                                    'text-sky-400 scale-110 rotate-3'
                                                )}
                                              />
                                            </div>

                                            {state === 'expanded' && (
                                              <span className="animate-in slide-in-from-left-3 duration-300">
                                                {child.title}
                                              </span>
                                            )}
                                          </Link>
